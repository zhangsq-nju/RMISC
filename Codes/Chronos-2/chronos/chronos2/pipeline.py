...
class Chronos2Pipeline(BaseChronosPipeline):
    ...
    def fit(
        ...
        **extra_trainer_kwargs
        ...
        from chronos.chronos2.trainer import Chronos2Trainer, EvaluateAndSaveFinalStepCallback, DebugGradTrainer
