...
class DataLoader:
    ...
    def __init__(
        self,
        dataset: Dataset,
        batch_size_per_rank: Optional[int] = None,
        ...
        ### 修改了batch size参数，目的是改为batch_size_per_rank。
        if batch_size_per_rank is None:
            raise ValueError("Either batch_size or batch_size_per_rank must be provided.")
